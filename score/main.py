...
import torch
import numpy as np
from Detector import DetectionsManager
from tqdm import tqdm
#from chip_utils.image_from_chip import img_from_chip_v2 as img_from_chip
#from chip_utils.csv_manager import load_gt_chip_csv 
#import sys
sys.path.append("chip_utils/")
from csv_manager import load_gt_chip_csv
from dev.image_from_chip import img_from_chip_v2 as img_from_chip
...
def yolact_predict(args):
    ...
    if args.VALIDATE_SCORE_SUBMISSIONS:
        ...
        from score_pred import submission_score
...
if __name__ == '__main__':
    ...
    PTH = 'yolact_r50_xView3_npy200_v1bg_11_30000.pth' #'yolact_r50_xView3_npy200_v1_15_40000.pth' #19_50000 15_40000 11_30000 7_20000 3_10000 23_60000 31_80000 27_70000 35_90000 39_100000
    CKPT='100k'
    ...
    args.SUBMISSION_CSV_PATH=os.path.join(MNT_ROOT,ML_DIR,f'{CKPT}_dev.csv')
